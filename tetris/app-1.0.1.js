!(function (t) {
      ...
      (l.cloneElement = function (t, e, n) {
        ...
        if (null != e) {
          ...
          for (s in e)
            u.call(e, s) &&
              !c.hasOwnProperty(s) &&
              (void 0 === e[s] && void 0 !== y ? (f[s] = y[s]) : (f[s] = e[s]));
        }
        ...
        if (g) {
          ...
          if (g !== t.entries)
            for (var w = 0; !(_ = b.next()).done; )
              (d = _.value), (h = m + r(d, w++)), (v += o(d, h, n, i));
          else
            for (; !(_ = b.next()).done; ) {
              var E = _.value;
              E &&
  ...
  function (t, e, n) {
    ...
    function c(t, e, n, r) {
      ...
      if (
        ...
        return null;
      C &&
        (O || o !== P.compositionStart
          ? o === P.compositionEnd && O && (c = O.getData())
          : (O = v.getPooled(r)));
  ...
  function (t, e, n) {
    ...
    var D = !1;
    C.canUseDOM &&
      (D = k("input") && (!document.documentMode || document.documentMode > 9));
    var L = {
      eventTypes: I,
      ...
      extractEvents: function (t, e, n, i) {
        var a,
          u,
          s = e ? S.getNodeFromInstance(e) : window;
        if (
          (o(s)
            ? N
              ? (a = l)
  ...
  function (t, e, n) {
    ...
    function u(t) {
      ...
      for (var n = 0; n < e; n++) {
        ...
        if (
          (v.performUpdateIfNecessary(r, t.reconcileTransaction, _),
          i && console.timeEnd(i),
          o)
        )
    ...
    function s(t) {
      return (
        ...
        E.isBatchingUpdates
          ? (g.push(t),
            void (
              null == t._updateBatchNumber && (t._updateBatchNumber = _ + 1)
            ))
          : void E.batchedUpdates(s, t)
      );
    }
    function c(t, e) {
      y(
    ...
    function o(t, e) {
      e &&
        ...
        null != e.dangerouslySetInnerHTML &&
          ...
          Y in e.dangerouslySetInnerHTML
            ? void 0
            : m("61")),
    ...
    function f() {
      ...
      switch ((e ? void 0 : m("64"), t._tag)) {
        ...
        case "audio":
          ...
          for (var n in H)
            H.hasOwnProperty(n) &&
              t._wrapperState.listeners.push(P.trapBubbledEvent(n, H[n], e));
          break;
        case "source":
          t._wrapperState.listeners = [
        ...
        _createOpenTagMarkupAndPutListeners: function (t, e) {
          ...
          for (var r in e)
            if (e.hasOwnProperty(r)) {
              var o = e[r];
              if (null != o)
                if (z.hasOwnProperty(r)) o && i(this, r, o, t);
                else {
                  r === V &&
            ...
            if (!e.hasOwnProperty(r) && t.hasOwnProperty(r) && null != t[r])
              if (r === V) {
                ...
                z.hasOwnProperty(r)
                  ? t[r] && U(this, r)
                  : h(this._tag, t)
                  ? W.hasOwnProperty(r) || C.deleteValueForAttribute(B(this), r)
                  : (E.properties[r] || E.isCustomAttribute(r)) &&
                    C.deleteValueForProperty(B(this), r);
          for (r in e) {
            var s = e[r],
  ...
  function (t, e, n) {
    ...
    var u = n(36),
      ...
      y = (n(11), n(119)),
      g = n(120),
      _ = (n(7), { ImpureClass: 0, PureClass: 1, StatelessFunctional: 2 });
  ...
  function (t, e, n) {
    ...
    function s(t, e, n) {
      for (
        S.unmountComponent(t, n), e.nodeType === N && (e = e.documentElement);
        e.lastChild;
  ...
  function (t, e, n) {
    ...
    (e.default = d),
      ...
      (d.childContextTypes = { store: f.default.isRequired });
  },
  function (t, e, n) {
    t.exports = n(175)();
  },
  ...
  function (t, e, n) {
    ...
    function c(t, e, n) {
      var r =
        ...
        p = t || S,
        h = void 0;
      h = "function" == typeof e ? e : e ? (0, y.default)(e) : x;
      var m = n || P,
        g = r.pure,
        _ = void 0 === g || g,
        b = r.withRef,
          ...
          r = (function (r) {
            ...
            return (
              ...
              (u.prototype.shouldComponentUpdate = function () {
                return (
                  !_ || this.haveOwnPropsChanged || this.hasStoreStateChanged
                );
              }),
              ...
              (u.prototype.updateStatePropsIfNeeded = function () {
                ...
                return (
                  (!this.stateProps || !(0, v.default)(t, this.stateProps)) &&
                  ((this.stateProps = t), !0)
                );
              }),
              (u.prototype.updateDispatchPropsIfNeeded = function () {
                ...
                return (
                  (!this.dispatchProps ||
                    !(0, v.default)(t, this.dispatchProps)) &&
              ...
              (u.prototype.updateMergedPropsIfNeeded = function () {
                ...
                return (
                  !(
                    this.mergedProps &&
                    k &&
                    (0, v.default)(t, this.mergedProps)
              ...
              (u.prototype.render = function () {
                ...
                return (
                  ...
                  !p && i
                    ? i
                    : (E
                        ? (this.renderedElement = (0, f.createElement)(
                            t,
                            l({}, this.mergedProps, { ref: "wrappedInstance" })
                          ))
                        : (this.renderedElement = (0, f.createElement)(
                            t,
                            this.mergedProps
    ...
    !(function (e, n) {
      ...
      function it(t) {
        ...
        if (
          ...
          ((t = t.valueOf()), t === !1 || null === t || void 0 === t)
        )
          return 0;
        if (t === !0) return 1;
        var e = typeof t;
      ...
      function st(t) {
        ...
        if (!An) {
          if (
            ((e = t.propertyIsEnumerable && t.propertyIsEnumerable[Ln]),
            void 0 !== e)
          )
            return e;
      ...
      function Ct(t, e, n) {
        ...
        if (t._root) {
          var i = l(gn),
            a = l(_n);
          if (((r = St(t._root, t.__ownerID, 0, void 0, e, n, i, a)), !a.value))
            return t;
      ...
      function kt(t, e, n, r, o) {
        for (var i = 0, a = new Array(vn), u = 0; 0 !== n; u++, n >>>= 1)
          a[u] = 1 & n ? e[i++] : void 0;
      ...
      function Bt(t) {
        ...
        return 0 === o
          ...
          : (lt(o),
            o > 0 && o < vn
              ? Vt(0, o, hn, null, new zt(n.toArray()))
      ...
      function Wt(t, e, n) {
        ...
        return (
          e >= $t(t._capacity)
            ...
            : (o = Kt(o, t.__ownerID, t._level, e, n, i)),
          i.value
            ? t.__ownerID
              ? ((t._root = o),
                (t._tail = r),
                ...
                (t.__altered = !0),
                t)
              : Vt(t._origin, t._capacity, t._level, o, r)
            : t
        );
      }
      ...
      function Xt(t, e, n) {
        ...
        if ((u < i && (v = v && v.removeAfter(r, 0, u)), a >= d))
          (a -= d),
            (u -= d),
            (s = hn),
            (c = null),
          ...
          (r.__iteratorUncached = function (r, o) {
            ...
            return new w(function () {
              for (; a; ) {
                ...
                if (t.done === !1) {
                  var c = t.value;
                  if ((r === En && (c = c[1]), (e && !(u.length < e)) || !i(c)))
      ...
      function Ce(t, n, r) {
        ...
        return (
          ...
          (o.__iterate = function (t, e) {
            for (
              var n, r = this.__iterator(wn, e), o = 0;
      ...
      (qn[zn] = !0),
        ...
        (dt.prototype.update = function (t, e, n, r, o, i, a) {
          for (
            var u = o === yn, s = this.entries, c = 0, l = s.length;
            c < l && !X(r, s[c][0]);
            c++
          );
          var p = c < l;
        ...
        (ht.prototype.update = function (t, e, n, r, o, i, a) {
          ...
          return v
            ? ((this.bitmap = m), (this.nodes = y), this)
            : new ht(t, m, y);
        }),
        ...
        (mt.prototype.update = function (t, e, n, r, o, i, a) {
          ...
          var u = o === yn;
          if (n !== this.keyHash)
            return u ? this : (f(a), f(i), Pt(this, t, e, n, [r, o]));
          for (
      ...
      (Jn[Hn] = !0),
        ...
        (zt.prototype.removeBefore = function (t, e, n) {
          ...
          if (e > 0) {
            var a = this.array[r];
            if (((o = a && a.removeBefore(t, e - hn, n)), o === a && i))
              return this;
          }
          if (i && !o) return this;
          var u = Ht(this, t);
      ...
      (e.Iterator = w),
        Qe(e, {
          ...
          isSuperset: function (t) {
            return (
              (t = "function" == typeof t.isSubset ? t : e(t)), t.isSubset(this)
            );
          },
          keyOf: function (t) {
      ...
      (sr[ln] = !0),
        ...
        Qe(r, {
          ...
          splice: function (t, e) {
            ...
            return Se(
              this,
              1 === n ? r : r.concat(d(arguments, 2), this.slice(t + e))
            );
          },
  ...
  function (t, e, n) {
    ...
    Object.defineProperty(e, "__esModule", { value: !0 }),
      (e.validateNextState =
        e.getUnexpectedInvocationParameterMessage =
        e.getStateName =
          void 0);
    var o = n(209),
      i = r(o),
  ...
  function (t, e) {
    t.exports = {
      ...
      data: {
        ...
        QRCode: { cn: "二维码", en: "QR code", fr: "QR code", fa: "کیوآر کد" },
        titleCenter: {
          cn: "俄罗斯方块<br />TETRIS",
          en: "TETRIS",
          fr: "TETRIS",
        ...
        point: { cn: "得分", en: "Point", fr: "Score", fa: "امتیاز" },
        highestScore: { cn: "最高分", en: "Max", fr: "Max", fa: "حداکثر" },
        lastRound: {
          cn: "上轮得分",
          en: "Last Round",
          fr: "Dernier Tour",
        ...
        cleans: { cn: "消除行", en: "Cleans", fr: "Lignes", fa: "پاک کرد" },
        level: { cn: "级别", en: "Level", fr: "Difficulté", fa: "سطح" },
        startLine: {
          cn: "起始行",
          en: "Start Line",
          fr: "Ligne Départ",
        ...
        next: { cn: "下一个", en: "Next", fr: "Prochain", fa: "بعدی" },
        pause: { cn: "暂停", en: "Pause", fr: "Pause", fa: "مکث" },
        sound: { cn: "音效", en: "Sound", fr: "Sonore", fa: "صدا" },
        reset: { cn: "重玩", en: "Reset", fr: "Réinitialiser", fa: "ریست" },
        rotation: { cn: "旋转", en: "Rotation", fr: "Rotation", fa: "چرخش" },
        left: { cn: "左移", en: "Left", fr: "Gauche", fa: "چپ" },
        right: { cn: "右移", en: "Right", fr: "Droite", fa: "راست" },
        down: { cn: "下移", en: "Down", fr: "Bas", fa: "پایین" },
        drop: { cn: "掉落", en: "Drop", fr: "Tomber", fa: "سقوط" },
      },
    };
  },
  function (t, e, n) {
  ...
  function (t, e, n) {
    ...
    var o = n(203),
      ...
      u = { data: !!a && location.protocol.indexOf("http") !== -1 },
      s = {};
    !(function () {
      if (u.data) {
        var t = "./music.mp3",
            ...
            e.decodeAudioData(
              ...
              function (e) {
                window.console &&
                  ...
                  (window.console.error("音频: " + t + " 读取错误", e),
                  (u.data = !1));
              }
            );
          }),
      ...
      (t.exports = { hasWebAudioAPI: u, music: s });
  },
  function (t, e, n) {
    "use strict";
    function r(t) {
    ...
    var o = n(207),
      ...
      s =
        u.lastRecord && Array.isArray(u.lastRecord.matrix)
          ? (0, o.List)(
              u.lastRecord.matrix.map(function (t) {
                return (0, o.List)(t);
              })
            )
          : u.blankMatrix,
          ...
          return r.every(function (t, r) {
            return t.every(function (t, i) {
              return (
                ...
                !(n[1] + o > 10) &&
                (n[0] + r < 0 ||
                  (!(n[0] + r >= 20) && (!t || !e.get(n[0] + r).get(n[1] + i))))
              );
            });
          });
        },
      ...
      u = (function () {
        function t(e) {
          if (
            ...
            (this.type = e.type),
            e.rotateIndex
              ? (this.rotateIndex = e.rotateIndex)
              : (this.rotateIndex = 0),
            e.timeStamp
            ...
            e.shape
              ? (this.shape = e.shape)
              : (this.shape = (0, i.List)(
                  a.blockShape[e.type].map(function (t) {
                    return (0, i.List)(t);
                  })
                )),
            e.xy)
          )
            this.xy = (0, i.List)(e.xy);
          else
            switch (e.type) {
              case "I":
            ...
            },
            {
              ...
              value: function () {
                ...
                return l.default.createElement(
                  "div",
                  { className: y.default.app, style: r },
                  l.default.createElement(
                    ...
                    l.default.createElement(w.default, null),
                    l.default.createElement(
                      "div",
                      ...
                      l.default.createElement(
                        ...
                        l.default.createElement(
                          ...
                          l.default.createElement(
                            ...
                            l.default.createElement(C.default, { time: !0 })
                          )
                        )
                      )
                    )
          ...
          u(e, [
            {
              ...
              value: function () {
                var t =
                  ...
                  n = t.reset;
                this.setState({ clearLines: e, isOver: n }),
            ...
            },
            {
              ...
              value: function () {
                ...
                return (
                  !(
                    f.default.is(t.matrix, e.matrix) &&
                    f.default.is(t.cur && t.cur.shape, e.cur && e.cur.shape) &&
                    f.default.is(t.cur && t.cur.xy, e.cur && e.cur.xy)
                  ) ||
            ...
            },
            {
              ...
              value: function () {
                var t = this,
                  e = function (e) {
                    E(function () {
                      t.setState({ animateColor: 0 }),
                        E(function () {
                          t.setState({ animateColor: 2 }),
                            "function" == typeof e && e();
                        }, 100);
                    }, 100);
                  };
    ...
    var o = n(207),
      ...
      p = function (t) {
        for (
          var e = function (t, e) {
              for (
                var n = parseInt((e - t + 1) * Math.random() + t, 10),
                  r = [],
                  i = 0;
                i < n;
                i++
        ...
        for (var i = 0, a = 20 - t; i < a; i++)
          n = n.unshift((0, o.List)(l.blankLine));
        return n;
      },
      d = {
        fallInterval: null,
        start: function () {
          ...
          a.default.dispatch(c.default.matrix(n)),
            a.default.dispatch(c.default.moveBlock({ type: t.get("next") })),
        ...
        auto: function (t) {
          var e = t < 0 ? 0 : t,
            ...
            o = function t() {
              ...
              var e = r.fall();
              if ((0, u.want)(e, n.get("matrix")))
                a.default.dispatch(c.default.moveBlock(e)),
                  (d.fallInterval = setTimeout(
                    t,
                    l.speeds[n.get("speedRun") - 1]
                  ));
              else {
                var o = n.get("matrix"),
                  i = r && r.shape,
          ...
          clearTimeout(d.fallInterval),
            (d.fallInterval = setTimeout(
              o,
              void 0 === e ? l.speeds[n.get("speedRun") - 1] : e
            ));
        },
        nextAround: function (t, e) {
          ...
          return (
            d.dispatchPoints(n),
            (0, u.isClear)(t)
              ? void (f.music.clear && f.music.clear())
              : (0, u.isOver)(t)
              ? (f.music.gameover && f.music.gameover(), void d.overStart())
        ...
        focus: function (t) {
          if ((a.default.dispatch(c.default.focus(t)), !t))
        ...
        pause: function (t) {
          return (
            a.default.dispatch(c.default.pause(t)),
        ...
        clearLines: function t(e, n) {
          ...
          n.forEach(function (t) {
            ...
            a.default.dispatch(c.default.moveBlock({ type: r.get("next") })),
            a.default.dispatch(c.default.nextBlock()),
            d.auto(),
            a.default.dispatch(c.default.lock(!1));
          ...
          var u =
            a.default.getState().get("points") + l.clearPoints[n.length - 1];
          d.dispatchPoints(u);
        ...
        overEnd: function () {
          a.default.dispatch(c.default.matrix(l.blankMatrix)),
            a.default.dispatch(c.default.moveBlock({ reset: !0 })),
        ...
        dispatchPoints: function (t) {
          a.default.dispatch(c.default.points(t)),
            t > 0 &&
              t > a.default.getState().get("max") &&
              a.default.dispatch(c.default.max(t));
        },
      };
    e.default = d;
  },
  function (t, e, n) {
    ...
    function i() {
      var t =
        arguments.length > 0 && void 0 !== arguments[0]
          ? arguments[0]
          : (0, b.getNextType)();
      return { type: E.NEXT_BLOCK, data: t };
    }
    function a(t) {
      return {
        type: E.MOVE_BLOCK,
    ...
    function u(t) {
      return { type: E.SPEED_START, data: t };
    }
    function s(t) {
      return { type: E.SPEED_RUN, data: t };
    }
    function c(t) {
      return { type: E.START_LINES, data: t };
    }
    function l(t) {
      return { type: E.MATRIX, data: t };
    }
    function f(t) {
      return { type: E.LOCK, data: t };
    }
    function p(t) {
      return { type: E.CLEAR_LINES, data: t };
    }
    function d(t) {
      return { type: E.POINTS, data: t };
    }
    function h(t) {
      return { type: E.MAX, data: t };
    }
    function v(t) {
      return { type: E.RESET, data: t };
    }
    function m(t) {
      return { type: E.DROP, data: t };
    }
    function y(t) {
      return { type: E.PAUSE, data: t };
    }
    function g(t) {
      return { type: E.MUSIC, data: t };
    }
    function _(t) {
      return { type: E.FOCUS, data: t };
    }
    Object.defineProperty(e, "__esModule", { value: !0 });
    var b = n(220),
      w = n(213),
  ...
  function (t, e, n) {
    ...
    function o(t) {
      return { type: d.KEY_DROP, data: t };
    }
    function i(t) {
      return { type: d.KEY_DOWN, data: t };
    }
    function a(t) {
      return { type: d.KEY_LEFT, data: t };
    }
    function u(t) {
      return { type: d.KEY_RIGHT, data: t };
    }
    function s(t) {
      return { type: d.KEY_ROTATE, data: t };
    }
    function c(t) {
      return { type: d.KEY_RESET, data: t };
    }
    function l(t) {
      return { type: d.KEY_MUSIC, data: t };
    }
    function f(t) {
      return { type: d.KEY_PAUSE, data: t };
    }
    Object.defineProperty(e, "__esModule", { value: !0 });
    var p = n(213),
      d = r(p);
            ...
            },
            {
              ...
              value: function () {
                return c.default.createElement(
                  ...
                  c.default.createElement("h1", null, p.i18n.title[p.lan]),
                  c.default.createElement(
                    "div",
                    { className: h.default.view },
                    c.default.createElement("b", { className: "c" }),
                    c.default.createElement("div", { className: "clear" }),
                    c.default.createElement("b", { className: "c" }),
                    c.default.createElement("b", { className: "c" }),
                    c.default.createElement("div", { className: "clear" }),
                    c.default.createElement("em", null),
                    c.default.createElement("b", { className: "c" }),
                    c.default.createElement("p", null),
                    c.default.createElement("em", null),
                    c.default.createElement("b", { className: "c" }),
                    c.default.createElement("div", { className: "clear" }),
                    c.default.createElement("b", { className: "c" }),
  ...
  function (t, e, n) {
    ...
    var u = (function () {
        ...
        return c.default.createElement(
          ...
          t.map(function (t, e) {
            return c.default.createElement("span", {
              className: (0, f.default)(["bg", v.default["s_" + t]]),
              key: e,
            });
          })
        );
      ...
      g = (function (t) {
        function e() {
          o(this, e);
          var t = i(this, (e.__proto__ || Object.getPrototypeOf(e)).call(this));
          return (t.state = { time_count: !1, time: new Date() }), t;
        }
        return (
          a(e, t),
          u(e, [
                ...
                if (this.props.time) {
                  var n = function n() {
                    ...
                    e.timeInterval = setTimeout(function () {
                      t.setState({ time: new Date(), time_count: r }), n();
                    }, 1e3);
                  };
                  n();
                }
            ...
            },
            {
              ...
              value: function (t) {
                ...
                return this.props.time
                  ? this.state.time_count !== e.time_count &&
                      (this.state.time_count !== !1 &&
                        (e.time_count = this.state.time_count),
                      !0)
                  : this.props.number !== n;
              },
            },
            ...
            },
            {
              ...
              value: function () {
                ...
                for (
                  var i = ("" + this.props.number).split(""),
                    a = 0,
                    u = this.props.length - i.length;
                  a < u;
                  a++
                )
                  i.unshift("n");
    ...
    (e.default = g),
      (g.statics = { timeInterval: null, time_count: null }),
      (g.propTypes = {
        number: d.default.number,
        length: d.default.number,
        time: d.default.bool,
      }),
      (g.defaultProps = { length: 6 });
  },
  function (t, e) {
    t.exports = {
      number: "iHKP",
  ...
  function (t, e, n) {
    ...
    (e.default = g), (g.propTypes = { data: p.default.string });
  },
  function (t, e) {
    t.exports = { next: "_3Wmt" };
  },
  function (t, e, n) {
    "use strict";
    function r(t) {
    ...
    (e.default = y), (y.propTypes = { data: h.default.bool.isRequired });
  },
  function (t, e) {
    t.exports = { music: "EHci", c: "TTF4" };
  },
  function (t, e, n) {
    "use strict";
    function r(t) {
    ...
    (e.default = y),
      (y.statics = { timeout: null }),
      (y.propTypes = { data: h.default.bool.isRequired }),
      (y.defaultProps = { data: !1 });
  },
  function (t, e) {
    t.exports = { pause: "_37mu", c: "_1vhq" };
  },
  function (t, e, n) {
    "use strict";
    function r(t) {
    ...
    var u = (function () {
      ...
      g = (function (t) {
        function e() {
          o(this, e);
          var t = i(this, (e.__proto__ || Object.getPrototypeOf(e)).call(this));
          return (t.state = { label: "", number: 0 }), t;
        }
        return (
          a(e, t),
          u(e, [
            ...
            },
            {
              ...
              value: function (t) {
                var n = this,
                  ...
                  o = t.point,
                  i = t.max;
                if ((clearInterval(e.timeout), r))
                  this.setState({ label: o >= i ? m : v, number: o });
                else {
                  var a = function t() {
                    n.setState({ label: y, number: o }),
                      (e.timeout = setTimeout(function () {
                        n.setState({ label: m, number: i }),
                          (e.timeout = setTimeout(t, 3e3));
                      }, 3e3));
                  };
                  0 !== o ? a() : this.setState({ label: m, number: i });
                }
              },
            },
            {
              ...
              value: function () {
                return c.default.createElement(
                  "div",
                  null,
                  c.default.createElement("p", null, this.state.label),
  ...
  function (t, e, n) {
    ...
    var s = (function () {
      ...
      g = (function (t) {
        function e() {
          i(this, e);
          var t = a(this, (e.__proto__ || Object.getPrototypeOf(e)).call(this));
          return (t.state = { style: m.default.r1, display: "none" }), t;
        }
        return (
          u(e, t),
          s(e, [
            ...
            },
            {
              key: "componentWillReceiveProps",
              value: function (t) {
                (([this.props.cur, t.cur].indexOf(!1) !== -1 &&
                  this.props.cur !== t.cur) ||
                  this.props.reset !== t.reset) &&
                  this.animate(t);
              },
            },
            {
            ...
            },
            {
              ...
              value: function (t) {
                ...
                if (
                  ...
                  this.setState({ style: m.default.r1, display: "none" }),
                  r || o)
                )
                  return void this.setState({ display: "none" });
                var i = "r",
                  a = 0,
                  u = function (t, n) {
                  ...
                  s = function (t) {
                    u(function () {
                      n.setState({ display: "block" }), t && t();
                    }, 150);
                  },
                  c = function (t) {
                    u(function () {
                      n.setState({ display: "none" }), t && t();
                    }, 150);
                  },
                  l = function (t, e, r) {
                    u(function () {
                      n.setState({ style: m.default[i + 2] }),
                        u(function () {
                          n.setState({ style: m.default[i + 1] }), t && t();
                        }, r);
                    }, e);
                  },
                  f = function t(e) {
                    u(function () {
                      n.setState({ style: m.default[i + 4] }),
                        u(function () {
                          return (
                            n.setState({ style: m.default[i + 3] }),
                            a++,
                            (10 !== a && 20 !== a && 30 !== a) ||
                              (i = "r" === i ? "l" : "r"),
                            a < 40
                              ? void t(e)
                              : (n.setState({ style: m.default[i + 1] }),
                                void (e && u(e, 4e3)))
                          );
                        }, 100);
                    }, 100);
                        ...
                        function () {
                          l(
                            function () {
                              l(
                                function () {
                                  n.setState({ style: m.default[i + 2] }), f(t);
                                },
                                150,
                                150
                              );
    ...
    (e.default = g),
      (g.propTypes = { cur: h.default.bool, reset: h.default.bool.isRequired }),
      (g.statics = { timeout: null });
  },
  function (t, e) {
    t.exports = {
              ...
              value: function () {
                ...
                document.addEventListener(
                  ...
                  Object.keys(w.default).forEach(function (r) {
                    t["dom_" + r].dom.addEventListener(
                      "mousedown",
                      function () {
                        e[r] !== !0 &&
                          (w.default[r].down(_.default), (n[r] = !0));
                      },
                      !0
                    ),
                      t["dom_" + r].dom.addEventListener(
                        ...
                        function () {
                          return e[r] === !0
                            ? void (e[r] = !1)
                            : (w.default[r].up(_.default), void (n[r] = !1));
                        },
                        !0
                      ),
                      t["dom_" + r].dom.addEventListener(
            ...
            },
            {
              ...
              value: function (t) {
                var e = t.keyboard,
                  n = t.filling;
                return (
                  !f.default.is(e, this.props.keyboard) ||
  ...
  function (t, e, n) {
    ...
    var o = n(220),
          ...
          a.default.down({
            ...
            callback: function () {
              ...
              if (!e.get("lock")) {
                ...
                var n = e.get("cur");
                if (null !== n) {
                  if (e.get("pause")) return void l.default.pause(!1);
                  var r = n.left(),
                    i = f.delays[e.get("speedRun") - 1],
                    a = void 0;
                  (0, o.want)(r, e.get("matrix"))
                    ? ((r.timeStamp += parseInt(i, 10)),
                      t.dispatch(s.default.moveBlock(r)),
                      (a = r.timeStamp))
                    : ((n.timeStamp += parseInt(parseInt(i, 10) / 1.5, 10)),
      ...
      h = function (t) {
        t.dispatch(s.default.keyboard.left(!1)), a.default.up({ key: "left" });
      };
    e.default = { down: d, up: h };
  },
  function (t, e) {
    "use strict";
    Object.defineProperty(e, "__esModule", { value: !0 });
    ...
    e.default = { down: r, up: o, clearAll: i };
  },
  function (t, e, n) {
    "use strict";
    function r(t) {
  ...
  function (t, e, n) {
    ...
    var o = n(220),
                ...
                callback: function (e) {
                  ...
                  if (!n.get("lock")) {
                    ...
                    if (null !== r) {
                      ...
                      var i = r.fall();
                      if ((0, o.want)(i, n.get("matrix")))
                        t.dispatch(s.default.moveBlock(i)), l.default.auto();
                      else {
                        var a = n.get("matrix"),
                          u = r.shape,
                          c = r.xy;
      ...
      d = function (t) {
        t.dispatch(s.default.keyboard.down(!1)), a.default.up({ key: "down" });
      };
    e.default = { down: p, up: d };
  },
  function (t, e, n) {
    "use strict";
    function r(t) {
  ...
  function (t, e, n) {
    ...
    var o = n(220),
            ...
            callback: function () {
              ...
              if (!e.get("lock")) {
                ...
                if (null !== n) {
                  ...
                  for (
                    var r = 0, i = n.fall(r);
                    (0, o.want)(i, e.get("matrix"));

                  )
                    (i = n.fall(r)), r++;
                  var a = e.get("matrix");
                  (i = n.fall(r - 2)), t.dispatch(s.default.moveBlock(i));
                  var u = i.shape,
                    c = i.xy;
                  u.forEach(function (t, e) {
                    return t.forEach(function (t, n) {
      ...
      d = function (t) {
        t.dispatch(s.default.keyboard.drop(!1)), a.default.up({ key: "space" });
      };
    e.default = { down: p, up: d };
  },
  function (t, e, n) {
        ...
        t.dispatch(u.default.keyboard.music(!0)),
          t.getState().get("lock") ||
            i.default.down({
              ...
              callback: function () {
                t.getState().get("lock") ||
                  t.dispatch(u.default.music(!t.getState().get("music")));
              },
            });
      },
      c = function (t) {
        t.dispatch(u.default.keyboard.music(!1)), i.default.up({ key: "s" });
      };
    e.default = { down: s, up: c };
  },
  function (t, e, n) {
    "use strict";
    function r(t) {
    ...
    var o = n(269),
      ...
      f = function (t) {
        t.dispatch(c.default.keyboard.reset(!1)), i.default.up({ key: "r" });
      };
  ...
  function (t, e, n) {
    ...
    var o = n(269),
      ...
      f = function (t) {
        t.dispatch(c.default.keyboard.pause(!1)), i.default.up({ key: "p" });
      };
    e.default = { down: l, up: f };
  },
  function (t, e, n) {
    ...
    var s = (function () {
      ...
      y = (function (t) {
        function e() {
          i(this, e);
          var t = a(this, (e.__proto__ || Object.getPrototypeOf(e)).call(this));
          return (t.state = { isMobile: (0, m.isMobile)(), QRCode: "" }), t;
        }
        return (
          u(e, t),
          s(e, [
            {
              ...
              value: function () {
                ...
                this.state.isMobile ||
                  p.default
                    .toDataURL(location.href, { margin: 1 })
                    .then(function (e) {
                      return t.setState({ QRCode: e });
                    });
              },
            },
            {
  ...
  function (t, e, n) {
    ...
    function l(t, e, n) {
      for (
        var r = d.getSymbolTotalCodewords(e),
          o = b.getTotalCodewordsCount(e, n),
          i = r - o,
          a = b.getBlocksCount(e, n),
          u = r % a,
          s = a - u,
          c = Math.floor(r / a),
          l = Math.floor(i / a),
      ...
      var x,
        ...
        O = 0;
      for (x = 0; x < _; x++)
        for (P = 0; P < a; P++) x < y[P].length && (T[O++] = y[P][x]);
    ...
    e.create = function (t, e) {
      ...
      return (
        "undefined" != typeof e &&
          ((o = h.from(e.errorCorrectionLevel, h.M)),
          (n = E.from(e.version)),
  ...
  function (t, e, n) {
    (function (e) {
      ...
      function e(t, n, r) {
        return e.TYPED_ARRAY_SUPPORT || this instanceof e
          ? "number" == typeof t
            ? u(this, t)
            : m(this, t, n, r)
          : new e(t, n, r);
      ...
      function a(t, n) {
        ...
        return (
          e.TYPED_ARRAY_SUPPORT
            ? ((r = new Uint8Array(n)), (r.__proto__ = e.prototype))
            : ((r = t), null === r && (r = new e(n)), (r.length = n)),
          r
        );
      }
      function u(t, n) {
      ...
      function c(t, e) {
        for (
          var n = e.length < 0 ? 0 : 0 | o(e.length), r = a(t, n), i = 0;
          i < n;
          i += 1
        )
          r[i] = 255 & e[i];
      ...
      function f(t, n) {
        ...
        if (n) {
          if (
            ...
            return "number" != typeof n.length || i(n.length)
              ? a(t, 0)
              : c(t, n);
      ...
      e.TYPED_ARRAY_SUPPORT &&
        ...
        (e.prototype.slice = function (t, n) {
          ...
          if (e.TYPED_ARRAY_SUPPORT)
            (o = this.subarray(t, n)), (o.__proto__ = e.prototype);
          else {
            var i = n - t;
            o = new e(i, void 0);
  ...
  function (t, e, n) {
    (function (t) {
      ...
      function l(t, e) {
        if ((s(e), (t = i(t, e < 0 ? 0 : 0 | v(e))), !a.TYPED_ARRAY_SUPPORT))
      ...
      (a.prototype.slice = function (t, e) {
        ...
        if (a.TYPED_ARRAY_SUPPORT)
          (r = this.subarray(t, e)), (r.__proto__ = a.prototype);
        else {
          var o = e - t;
          r = new a(o, void 0);
  ...
  function (t, e) {
    ...
    function i(t) {
      for (
        ...
        (e =
          (l[t.charCodeAt(p)] << 18) |
          (l[t.charCodeAt(p + 1)] << 12) |
          (l[t.charCodeAt(p + 2)] << 6) |
          l[t.charCodeAt(p + 3)]),
          (u[s++] = (e >> 16) & 255),
          (u[s++] = (e >> 8) & 255),
          (u[s++] = 255 & e);
      return (
        2 === a &&
          ((e = (l[t.charCodeAt(p)] << 2) | (l[t.charCodeAt(p + 1)] >> 4)),
          (u[s++] = 255 & e)),
        1 === a &&
          ((e =
            (l[t.charCodeAt(p)] << 10) |
            (l[t.charCodeAt(p + 1)] << 4) |
            (l[t.charCodeAt(p + 2)] >> 2)),
          (u[s++] = (e >> 8) & 255),
          (u[s++] = 255 & e)),
        u
      );
    ...
    (e.isValid = function (t) {
      ...
      (e.getPenaltyN1 = function (t) {
        for (
          ...
          for (var c = 0; c < e; c++) {
            var l = t.get(s, c);
            l === a ? o++ : (o >= 5 && (n += r.N1 + (o - 5)), (a = l), (o = 1)),
              (l = t.get(c, s)),
              l === u
                ? i++
                : (i >= 5 && (n += r.N1 + (i - 5)), (u = l), (i = 1));
          }
  ...
  function (t, e, n) {
    ...
    function i(t) {
      var e,
        n,
        r = o(m.NUMERIC, f.NUMERIC, t),
        i = o(m.ALPHANUMERIC, f.ALPHANUMERIC, t);
      y.isKanjiModeEnabled()
        ? ((e = o(m.BYTE, f.BYTE, t)), (n = o(m.KANJI, f.KANJI, t)))
        : ((e = o(m.BYTE_KANJI, f.BYTE, t)), (n = []));
      ...
      for (var e = [], n = 0; n < t.length; n++) {
        ...
        switch (o.mode) {
          case f.NUMERIC:
            e.push([
              o,
              { data: o.data, mode: f.ALPHANUMERIC, length: o.length },
              { data: o.data, mode: f.BYTE, length: o.length },
            ]);
            break;
          case f.ALPHANUMERIC:
            e.push([o, { data: o.data, mode: f.BYTE, length: o.length }]);
            break;
          case f.KANJI:
            e.push([o, { data: o.data, mode: f.BYTE, length: r(o.data) }]);
            break;
          case f.BYTE:
            e.push([{ data: o.data, mode: f.BYTE, length: r(o.data) }]);
        }
      }
      return e;
    }
    function c(t, e) {
      for (
        ...
        for (var u = t[i], s = [], c = 0; c < u.length; c++) {
          var l = u[c],
            p = "" + i + c;
          s.push(p), (n[p] = { node: l, lastCount: 0 }), (r[p] = {});
          for (var d = 0; d < o.length; d++) {
            var h = o[d];
            n[h] && n[h].node.mode === l.mode
              ? ((r[h][p] =
                  a(n[h].lastCount + l.length, l.mode) -
                  a(n[h].lastCount, l.mode)),
                (n[h].lastCount += l.length))
              : (n[h] && (n[h].lastCount = l.length),
                (r[h][p] =
                  a(l.length, l.mode) +
                  4 +
                  f.getCharCountIndicator(l.mode, e)));
          }
        }
        o = s;
      }
    ...
    function l(t, e) {
      var n,
        r = f.getBestModeForData(t);
      if (((n = f.from(e, r)), n !== f.BYTE && n.bit < r.bit))
        throw new Error(
          '"' +
            t +
    ...
    (e.fromArray = function (t) {
      ...
      (e.fromString = function (t, n) {
        for (
          var r = i(t, y.isKanjiModeEnabled()),
            o = s(r),
            a = c(o, n),
  ...
  function (t, e, n) {
    ...
    (e.render = function (t, e, n) {
      var a = n,
        u = e;
      "undefined" != typeof a || (e && e.getContext) || ((a = e), (e = void 0)),
        e || (u = o()),
        (a = i.getOptions(a));
      ...
      return (
        i.qrToImageData(l.data, t, a), r(c, u, s), c.putImageData(l, 0, 0), u
      );
    }),
    ...
    var o = n(203),
      ...
      f = function (t) {
        if (t.metaKey !== !0 && l.indexOf(t.keyCode) !== -1) {
          var e = s[t.keyCode];
          e !== c && ((c = e), u.default[e].down(i.default));
        }
      },
      p = function (t) {
        if (t.metaKey !== !0 && l.indexOf(t.keyCode) !== -1) {
          var e = s[t.keyCode];
          e === c && (c = ""), u.default[e].up(i.default);
        }
      };
